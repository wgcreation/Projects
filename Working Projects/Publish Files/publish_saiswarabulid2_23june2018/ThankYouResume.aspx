<%@ page language="C#" autoeventwireup="true" inherits="ThankYouResume, App_Web_thankyouresume.aspx.cdcab7d2" %>
...
<head id="Head1" runat="server">
    ...
    <title>SaiSwara Thank You Resume</title>
            ...
            <div class="About_area" style="text-align: center;">
                <div class="section_banner_spacing pT50">
                    <div class="sec-head-container">
                        ...
                        <p class="thankyou_txt"><b>Thanks for submitting your profile. </b>We will get back to you shortly.</p>
                        <hr />
