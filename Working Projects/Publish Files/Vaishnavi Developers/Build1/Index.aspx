                    ...
                    <section class="section_video" id="home">
                        <div class="row" style="margin-left: 0; margin-right: 0;">
                            <div class="col-sm-12 pd">
                                <div class="videobox">
                                    <iframe src="https://www.youtube.com/embed/IuzFgCRBTiQ?ecver=2" style="position: absolute; width: 100%; height: 100%; left: 0" width="641" height="360" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                                </div>
                            </div>
                        </div>
                    </section>
                                    ...
                                    <div class="whitebox">
                                        ...
                                        <div class="input-group home-btn-grp">
                                            <asp:DropDownList ID="ddPropertyType" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddPropertyType_SelectedIndexChanged" Class="form-control form-txt">
                                                <asp:ListItem Enabled="true" Selected="True" Text="--Select Type--" Value="0"></asp:ListItem>
                        ...
                        <div class="container">
                            ...
                            <div class="row text-center wow fadeInUp" data-wow-duration="2s">
                                <div class="col-sm-4 mT20">
                                    ...
                                    <a href="#">
                                        <img src="images/arrow-img.png" width="40" height="15" alt="Arrow Image" /></a>
                                </div>
                                <div class="col-sm-4 mT20">
                        ...
                        <div class="row wow fadeInUp" data-wow-duration="2s">
                            <div class="container">
                                <div class="col-sm-6">
                                    ...
                                    <p class="contact-paratext">
                                        1, Chinchpada Rd, Amrai, Chinchpada Gaon, Kalyan, Maharashtra 421306<br />
                                ...
                                <div class="col-sm-6" id="news">
                                    ...
                                    <div class="input-group home-btn-grp">
                                        <input type="text" class="form-control form-txt" placeholder="Enter Your Name" />
                                    </div>
                                    <div class="input-group home-btn-grp">
                                        <input type="text" class="form-control form-txt" placeholder="Enter Your Email" />
                                    </div>
